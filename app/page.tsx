...
export default function HomePage() {
      ...
      <section className="relative min-h-screen overflow-hidden bg-[#fff3dc] px-6 pb-20 pt-28">
        ...
        <div className="relative z-10 mx-auto grid min-h-[calc(100vh-7rem)] max-w-[1550px] items-center gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          >
            ...
            <h1 className="max-w-4xl text-5xl font-black leading-[0.92] tracking-[-0.04em] text-[#241104] sm:text-6xl md:text-8xl">
              Cold-Pressed
          ...
          >
            <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
              ...
              <div className="max-w-2xl">
                ...
                <div className="mt-8 rounded-[2rem] border border-[#d8b56d]/40 bg-white/75 p-6 shadow-xl backdrop-blur">
                  <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                      ...
                      <p className="mt-2 text-4xl font-black text-[#241104]">
                        $14.99
                        <span className="ml-2 text-base font-bold text-[#5c4634]">
                          CAD
                        </span>
                      </p>

                      <p className="mt-1 text-sm font-bold text-[#5c4634]">
                        20 LB bag · Quantity selectable at checkout
                      </p>
                    </div>

                    <AddToCartButton productName="Desi Ghraat Style Atta" />
                  </div>
                </div>

                <a
                  href="#stores"
                  className="mt-5 inline-block rounded-full border border-[#2a1608]/20 bg-white/60 px-8 py-4 text-sm font-bold text-[#2a1608] transition hover:scale-105"
                >
                  Available In Stores
                </a>
              </div>
  ...
  <div>
    <h3 className="text-lg font-black text-[#241104]">
      What Virsa Means
    </h3>

    <p className="mt-2 leading-8 text-[#5c4634]">
      Virsa means heritage. For us, heritage is the taste that feels like home — soft rotis, family meals, and traditions passed down through generations.
    </p>
  </div>

  <div>
    <h3 className="text-lg font-black text-[#241104]">
      Why We Started Virsa
    </h3>

    <p className="mt-2 leading-8 text-[#5c4634]">
      Many flours look good on the shelf, but they often lack the texture, consistency, and performance families expect from true desi-style atta. Virsa was created to deliver authentic taste, dependable quality, and a premium experience you can trust every day.
    </p>
  </div>
  ...
  <div>
    ...
    <p className="mt-2 leading-8 text-[#5c4634]">
      Premium means consistency — dough that feels right, rotis that roll easily, and the same quality in every bag. No shortcuts. No compromises.
    </p>
  </div>
</div>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
            <div className="max-w-2xl">
              ...
              <h2 className="text-4xl font-black leading-tight md:text-5xl text-[#241104] md:text-6xl">
      ...
      <section id="contact" className="relative overflow-hidden bg-[#130902] px-6 py-32 text-white">
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="text-4xl font-black leading-tight md:text-5xl md:text-7xl">
              Bring Premium Atta
